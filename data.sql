...
insert into user (id, username, password, nickname, lastPasswordResetDate)
values
  (1, 'mackwang', 'secret', '愚人云端', now()),
  (2, 'macksteve', 'secret', '鲍伯', now());
...
insert into article (id,title, catalogId, content, words, createdAt, updatedAt)
values
